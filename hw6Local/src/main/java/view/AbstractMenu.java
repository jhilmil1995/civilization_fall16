...
public class AbstractMenu {
    ...
    public AbstractMenu() {
        ...
        terrain.setFont(Font.font("Verdana", 20));
        unitStatus.setFont(Font.font("Verdana", 15));
        exploreButton.setStyle("-fx-font: 30 arial; -fx-base: #ee2211;");
        endTurnButton.setStyle("-fx-font: 30 arial; -fx-base: #ee2211;");
        ...
        menu.setPrefWidth(PREFWIDTH);
        updateItems();
        Image img = new Image("File:./src/main/java/view/civ.jpg");
        ImageView imgView = new ImageView(img);
        StackPane sp = new StackPane(imgView, menu);
        vbox.getChildren().add(sp);
        vbox.setPrefWidth(PREFWIDTH);
        vbox.setPrefHeight(PREFWIDTH);
    }
    /**
